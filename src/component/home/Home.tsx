  ...
  return (
    <LayoutMaxwidthWrapper>
        ...
        <Right>
            ...
            <><ShareOption>
                      <Icon>share</Icon>
                      <Icon><a href='/facebook' className='icons'><img src='../images/icon-facebook.svg' alt='' /></a></Icon>
                      <Icon><a href='/twitter' className='icons'><img src='../images/icon-twitter.svg' alt='' /></a></Icon>
                      <Icon><a href='/pinterest' className='icons'><img src='../images/icon-pinterest.svg' alt='' /></a></Icon>
                  </ShareOption>
                  {/* <div>
